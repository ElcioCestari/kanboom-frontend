...
import { PageCreateNewBoardComponent } from '../page-create-new-board-component/page-create-new-board.component';
...
export class PageViewBoardComponent implements OnInit {
  ...
  constructor(private userService: UserService, private usuario: Usuario, private renderer: Renderer2) { }
